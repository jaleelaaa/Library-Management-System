...
const enTranslations: Translations = {
  ...
  'nav.patronGroups': 'Patron Groups',
  ...
  'users.error.fetchUser': 'Failed to fetch user',
  'users.error.create': 'Failed to create user',
  'users.error.update': 'Failed to update user',
  'users.error.delete': 'Failed to delete user',
  'users.error.fetchPatronGroups': 'Failed to fetch patron groups',
  'users.error.fetchDepartments': 'Failed to fetch departments',
  ...
  'roles.error.fetch': 'Failed to fetch roles',
  'roles.error.fetchRole': 'Failed to fetch role',
  'roles.error.fetchPermissions': 'Failed to fetch permissions',
  ...
  'items.error.fetch': 'Failed to fetch items',
  'items.error.save': 'Failed to save item',
  ...
  'holdings.error.fetch': 'Failed to fetch holdings',
  'holdings.error.save': 'Failed to save holding',

  // Instances Errors
  'instances.error.fetch': 'Failed to fetch instances',
  'instances.error.create': 'Failed to create instance',
  'instances.error.update': 'Failed to update instance',
  'instances.error.delete': 'Failed to delete instance',
  ...
  // Circulation - Recent Transactions
  'circulation.recentTransactions': 'Recent Transactions',
  'circulation.noTransactions': 'No recent transactions',
  'circulation.clear': 'Clear',
  'circulation.checkedOut': 'Checked Out',
  'circulation.checkedIn': 'Checked In',
  'circulation.renewed': 'Renewed',
  'circulation.unknownItem': 'Unknown Item',
  'circulation.item': 'Item',
  'circulation.user': 'User',
  'circulation.due': 'Due',
  'circulation.overdueFine': 'Overdue fine',
  ...
  'loans.renewSuccess': 'Item renewed successfully!',
  'loans.error.renewFailed': 'Failed to renew item',

  // Circulation Errors
  'circulation.error.checkout': 'Failed to check out item',
  'circulation.error.checkin': 'Failed to check in item',
  'circulation.error.renew': 'Failed to renew loan',
  'circulation.error.fetchLoans': 'Failed to fetch loans',
  'circulation.error.fetchRequests': 'Failed to fetch requests',
  'circulation.error.createRequest': 'Failed to create request',
  'circulation.error.cancelRequest': 'Failed to cancel request',

  // Requests
  'requests.cancelConfirm': 'Are you sure you want to cancel this request?',
  'circulation.requests.title': 'Requests (Holds)',
  'circulation.requests.subtitle': 'Manage hold requests, recalls, and page requests',
  'circulation.requests.createRequest': 'Create Request',
  'circulation.requests.noRequests': 'No requests found',
  'circulation.requests.noRequests.desc': 'Create your first request to get started',
  'circulation.requests.position': 'Position',
  'circulation.requests.item': 'Item',
  'circulation.requests.user': 'User',
  'circulation.requests.type': 'Type',
  'circulation.requests.requestDate': 'Request Date',
  'circulation.requests.expirationDate': 'Expiration Date',
  'circulation.requests.status': 'Status',
  'circulation.requests.status.open': 'Open',
  'circulation.requests.status.closed': 'Closed',
  'circulation.requests.status.cancelled': 'Cancelled',
  'circulation.requests.type.hold': 'Hold',
  'circulation.requests.type.recall': 'Recall',
  'circulation.requests.type.page': 'Page',
  'circulation.requests.filters.status': 'Filter by Status',
  'circulation.requests.filters.type': 'Filter by Type',
  'circulation.requests.form.userBarcode': 'User Barcode',
  'circulation.requests.form.userBarcodePlaceholder': 'Scan or enter user barcode',
  'circulation.requests.form.itemBarcode': 'Item Barcode',
  'circulation.requests.form.itemBarcodePlaceholder': 'Scan or enter item barcode',
  'circulation.requests.form.requestType': 'Request Type',
  'circulation.requests.form.expirationDate': 'Expiration Date (Optional)',
  'circulation.requests.form.optional': 'Optional field',
  'circulation.requests.button.create': 'Create Request',
  'circulation.requests.button.cancelRequest': 'Cancel Request',
  'circulation.requests.cancel.confirm': 'Cancel Request?',
  'circulation.requests.cancel.message': 'Are you sure you want to cancel the request for "{itemTitle}"?',
  'circulation.requests.cancel.warning': 'This action cannot be undone.',
  'circulation.requests.cancelSuccess': 'Request cancelled successfully',
  'circulation.requests.cancelError': 'Failed to cancel request',
  'circulation.requests.createSuccess': 'Request created successfully',
  'circulation.requests.createError': 'Failed to create request',
  ...
  'reports.form.exportFormat': 'Export Format',
  'reports.form.startDate': 'Start Date',
  'reports.form.endDate': 'End Date',
  'reports.form.includeFines': 'Include Fines',
  'reports.form.includeStats': 'Include Statistics',
  'reports.form.minDaysOverdue': 'Minimum Days Overdue',
  'reports.types.circulation': 'Circulation',
  'reports.types.collection': 'Collection',
  'reports.types.financial': 'Financial',
  'reports.types.overdue': 'Overdue',
  'reports.titles.circulation': 'Circulation Report',
  'reports.titles.collection': 'Collection Report',
  'reports.titles.financial': 'Financial Report',
  'reports.titles.overdue': 'Overdue Report',
  'reports.formats.json': 'JSON',
  'reports.formats.csv': 'CSV',
  'reports.formats.excel': 'Excel',
  'reports.formats.pdf': 'PDF',
  'reports.stats.totalCheckouts': 'Total Checkouts',
  'reports.stats.totalItems': 'Total Items',
  'reports.stats.totalUsers': 'Total Users',
  'reports.stats.allocatedFunds': 'Allocated Funds',
  'reports.stats.expended': 'Expended',
  'reports.stats.available': 'Available Funds',
  'reports.display.generated': 'Generated',
  'reports.display.totalRecords': 'Total Records',
  'reports.display.summary': 'Summary',
  'reports.display.showing100': 'Showing first 100 of {{total}} records',
  'reports.display.noData': 'No data available',
  ...
  'audit.resources.instances': 'Instances',
  'audit.resources.items': 'Items',
  'audit.resources.loans': 'Loans',
  'audit.resources.holdings': 'Holdings',
  'audit.resources.orders': 'Orders',
  'audit.resources.invoices': 'Invoices',
  ...
  // Additional Vendor translations
  'acquisitions.vendors.subtitle': 'Manage vendor relationships and payment terms',
  'acquisitions.vendors.modal.create': 'Create Vendor',
  'acquisitions.vendors.modal.edit': 'Edit Vendor',
  'acquisitions.vendors.modal.createDesc': 'Add a new vendor to your acquisitions system',
  'acquisitions.vendors.modal.editDesc': 'Update vendor information and settings',
  'acquisitions.vendors.paymentMethodPlaceholder': 'Enter payment method',
  'acquisitions.vendors.deleteTitle': 'Delete Vendor',
  ...
  'acquisitions.invoices.subtitle': 'Manage and process vendor invoices',
  ...
  'acquisitions.invoices.modal.view': 'View Invoice',
  'acquisitions.invoices.modal.createDesc': 'Create a new invoice for vendor payment',
  'acquisitions.invoices.modal.editDesc': 'Update invoice details and payment information',
  'acquisitions.invoices.modal.viewDesc': 'View invoice details',
  'acquisitions.invoices.table.invoiceNumber': 'Invoice Number',
  'acquisitions.invoices.table.vendor': 'Vendor',
  'acquisitions.invoices.table.date': 'Invoice Date',
  'acquisitions.invoices.table.status': 'Status',
  'acquisitions.invoices.table.total': 'Total Amount',
  'acquisitions.invoices.table.actions': 'Actions',
  'acquisitions.invoices.form.invoiceNumber': 'Invoice Number',
  'acquisitions.invoices.form.invoiceNumberPlaceholder': 'Enter invoice number',
  'acquisitions.invoices.form.vendor': 'Vendor',
  'acquisitions.invoices.form.selectVendor': 'Select a vendor',
  ...
  'acquisitions.invoices.form.descriptionPlaceholder': 'Enter invoice description',
  'acquisitions.invoices.deleteTitle': 'Delete Invoice',
  ...
  // Acquisitions Errors
  'vendors.error.fetch': 'Failed to fetch vendors',
  'vendors.error.fetchVendor': 'Failed to fetch vendor',
  'vendors.error.create': 'Failed to create vendor',
  'vendors.error.update': 'Failed to update vendor',
  'vendors.error.delete': 'Failed to delete vendor',
  'funds.error.fetch': 'Failed to fetch funds',
  'funds.error.create': 'Failed to create fund',
  'funds.error.update': 'Failed to update fund',
  'funds.error.delete': 'Failed to delete fund',
  'purchaseOrders.error.fetch': 'Failed to fetch purchase orders',
  'purchaseOrders.error.fetchOrder': 'Failed to fetch purchase order',
  'purchaseOrders.error.create': 'Failed to create purchase order',
  'purchaseOrders.error.update': 'Failed to update purchase order',
  'purchaseOrders.error.delete': 'Failed to delete purchase order',
  'invoices.error.fetch': 'Failed to fetch invoices',
  'invoices.error.fetchInvoice': 'Failed to fetch invoice',
  ...
  'fees.error.fetch': 'Failed to fetch fees',
  'fees.error.fetchPayments': 'Failed to fetch payments',
  ...
  'courses.deleteConfirm': 'Are you sure you want to delete this course? This will also delete all associated reserves.',
  ...
  // Courses - Errors
  'courses.error.fetch': 'Failed to fetch courses',
  'courses.error.fetchCourse': 'Failed to fetch course',
  'courses.error.create': 'Failed to create course',
  'courses.error.update': 'Failed to update course',
  'courses.error.delete': 'Failed to delete course',
  'reserves.error.fetch': 'Failed to fetch reserves',
  'reserves.error.create': 'Failed to create reserve',
  'reserves.error.delete': 'Failed to delete reserve',
  ...
  'acquisitions.funds.modal.createDesc': 'Add a new fund to your acquisitions system',
  'acquisitions.funds.modal.editDesc': 'Update fund information and budget details',
  'acquisitions.funds.modal.viewDesc': 'View fund details and allocation information',
  'acquisitions.funds.noFunds': 'No funds found',
  'acquisitions.funds.subtitle': 'Manage library budgets and fund allocations',
  'acquisitions.funds.codePlaceholder': 'Enter fund code',
  'acquisitions.funds.namePlaceholder': 'Enter fund name',
  'acquisitions.funds.descriptionPlaceholder': 'Enter fund description',
  'acquisitions.funds.deleteTitle': 'Delete Fund',
  ...
  'notifications.error.fetch': 'Failed to fetch notifications',
  'notifications.error.fetchUnread': 'Failed to fetch unread count',
  'notifications.error.markRead': 'Failed to mark notification as read',
  'notifications.error.markAllRead': 'Failed to mark all as read',
  'notifications.error.delete': 'Failed to delete notification',
  'notifications.error.deleteAll': 'Failed to delete notifications',

  // Dashboard Errors
  'dashboard.error.fetchStats': 'Failed to fetch dashboard stats',
  'dashboard.error.fetchLoans': 'Failed to fetch recent loans',

  // Auth Errors
  'auth.error.fetchProfile': 'Failed to fetch user profile',

  // Settings - Locations
  'locations.title': 'Locations',
  'locations.subtitle': 'Manage physical locations for items',
  'locations.new': 'New Location',
  'locations.filterByLibrary': 'Filter by Library',
  'locations.allLibraries': 'All Libraries',
  'locations.filterByStatus': 'Filter by Status',
  'locations.allStatuses': 'All Statuses',
  'locations.noLocations': 'No locations found',
  'locations.noLocations.desc': 'Create your first location to get started',
  'locations.code': 'Code',
  'locations.name': 'Name',
  'locations.library': 'Library',
  'locations.modal.create': 'Create Location',
  'locations.modal.edit': 'Edit Location',
  'locations.modal.view': 'View Location',
  'locations.modal.createDesc': 'Add a new location to your system',
  'locations.modal.editDesc': 'Update location information',
  'locations.modal.viewDesc': 'View location details',
  'locations.codeImmutable': 'Code cannot be changed after creation',
  'locations.description': 'Description',
  'locations.descriptionPlaceholder': 'Enter location description...',
  'locations.discoveryDisplayName': 'Discovery Display Name',
  'locations.discoveryPlaceholder': 'Name shown in public catalog',
  'locations.discoveryHelp': 'The name displayed to patrons in the public catalog',
  'locations.noLibrary': 'No Library',
  'locations.activeLocation': 'Active location',
  'locations.deleteTitle': 'Delete Location',
  'locations.deleteConfirm': 'Are you sure you want to delete this location? This may affect associated items.',
  'locations.namePlaceholder': 'Main Stacks',

  // Settings - Libraries
  'libraries.title': 'Libraries',
  'libraries.subtitle': 'Manage library branches and organizational units',
  'libraries.new': 'New Library',
  'libraries.searchPlaceholder': 'Search libraries...',
  'libraries.noLibraries': 'No libraries found',
  'libraries.noLibraries.desc': 'Create your first library to get started',
  'libraries.table.code': 'Code',
  'libraries.table.name': 'Name',
  'libraries.table.created': 'Created',
  'libraries.table.actions': 'Actions',
  'libraries.modal.create': 'Create Library',
  'libraries.modal.edit': 'Edit Library',
  'libraries.modal.view': 'View Library',
  'libraries.modal.createDesc': 'Add a new library branch to your system',
  'libraries.modal.editDesc': 'Update library information',
  'libraries.modal.viewDesc': 'View library details',
  'libraries.form.code': 'Library Code',
  'libraries.form.name': 'Library Name',
  'libraries.codeImmutable': 'Code cannot be changed after creation',
  'libraries.codeHelp': 'Unique code to identify this library (e.g., MAIN, BRANCH1)',
  'libraries.namePlaceholder': 'Main Library',
  'libraries.nameHelp': 'Full name of the library',
  'libraries.created': 'Created',
  'libraries.updated': 'Updated',
  'libraries.deleteTitle': 'Delete Library',
  'libraries.deleteConfirm': 'Are you sure you want to delete this library? This may affect associated locations.',

  // Settings - Loan Policies
  'loanPolicies.title': 'Loan Policies',
  'loanPolicies.subtitle': 'Configure circulation rules and loan periods',
  'loanPolicies.new': 'New Loan Policy',
  'loanPolicies.filterByStatus': 'Filter by Status',
  'loanPolicies.allStatuses': 'All Statuses',
  'loanPolicies.activeOnly': 'Active Only',
  'loanPolicies.inactiveOnly': 'Inactive Only',
  'loanPolicies.noPolicies': 'No loan policies found',
  'loanPolicies.noPolicies.desc': 'Create your first policy to get started',
  'loanPolicies.code': 'Code',
  'loanPolicies.name': 'Name',
  'loanPolicies.loanPeriod': 'Loan Period',
  'loanPolicies.renewability': 'Renewability',
  'loanPolicies.grace': 'Grace',
  'loanPolicies.yes': 'Yes',
  'loanPolicies.no': 'No',
  'loanPolicies.renewals': 'renewals',
  'loanPolicies.modal.create': 'Create Loan Policy',
  'loanPolicies.modal.edit': 'Edit Loan Policy',
  'loanPolicies.modal.view': 'View Loan Policy',
  'loanPolicies.modal.createDesc': 'Add a new loan policy to configure circulation rules',
  'loanPolicies.modal.editDesc': 'Update loan policy settings and periods',
  'loanPolicies.modal.viewDesc': 'View loan policy details and configuration',
  'loanPolicies.codeHelp': 'Unique code (e.g., STANDARD_LOAN, SHORT_TERM)',
  'loanPolicies.namePlaceholder': 'Standard Loan Policy',
  'loanPolicies.descriptionPlaceholder': 'Description of this loan policy',
  'loanPolicies.description': 'Description',
  'loanPolicies.duration': 'Duration',
  'loanPolicies.interval': 'Interval',
  'loanPolicies.renewable': 'Renewable',
  'loanPolicies.numberOfRenewals': 'Number of Renewals',
  'loanPolicies.renewalDuration': 'Renewal Duration',
  'loanPolicies.renewalInterval': 'Renewal Interval',
  'loanPolicies.gracePeriod': 'Grace Period',
  'loanPolicies.graceHelp': 'Period after due date before overdue fees apply',
  'loanPolicies.recallConfig': 'Recall Configuration (Optional)',
  'loanPolicies.returnIntervalDuration': 'Return Interval Duration',
  'loanPolicies.returnInterval': 'Return Interval',
  'loanPolicies.recallPlaceholder': 'Leave blank if not applicable',
  'loanPolicies.deleteTitle': 'Delete Loan Policy',
  'loanPolicies.deleteConfirm': 'Are you sure you want to delete this loan policy?',

  // Settings - Fee Policies
  ...
  'feePolicies.filterByType': 'Filter by Type',
  'feePolicies.filterByStatus': 'Filter by Status',
  'feePolicies.allTypes': 'All Fee Types',
  'feePolicies.allStatuses': 'All Statuses',
  'feePolicies.activeOnly': 'Active Only',
  'feePolicies.inactiveOnly': 'Inactive Only',
  'feePolicies.noPolicies': 'No fee policies found',
  'feePolicies.noPolicies.desc': 'Create your first policy to get started',
  'feePolicies.table.code': 'Code',
  'feePolicies.table.name': 'Name',
  'feePolicies.table.type': 'Fee Type',
  'feePolicies.table.amounts': 'Amounts',
  'feePolicies.table.status': 'Status',
  'feePolicies.code': 'Code',
  'feePolicies.codeHint': 'Unique code (e.g., OVERDUE_STD, LOST_ITEM)',
  'feePolicies.feeType': 'Fee Type',
  'feePolicies.name': 'Name',
  'feePolicies.namePlaceholder': 'Standard Overdue Policy',
  'feePolicies.description': 'Description',
  'feePolicies.descriptionPlaceholder': 'Description of this fee policy',
  'feePolicies.feeAmounts': 'Fee Amounts',
  'feePolicies.initialAmount': 'Initial',
  'feePolicies.initialAmountHint': 'Initial charge when fee is created',
  'feePolicies.perDay': 'Per Day',
  'feePolicies.perDayAmount': 'Per Day Amount',
  'feePolicies.perDayAmountHint': 'Daily rate (for overdue fees)',
  'feePolicies.max': 'Max',
  'feePolicies.maxAmount': 'Maximum Amount',
  'feePolicies.maxAmountHint': 'Maximum charge cap',
  'feePolicies.grace': 'Grace',
  'feePolicies.gracePeriod': 'Grace Period (Days)',
  'feePolicies.gracePeriodHint': 'Days before fees start accruing',
  'feePolicies.days': 'days',
  'feePolicies.created': 'Created',
  'feePolicies.updated': 'Updated',
  'feePolicies.id': 'ID',
  'feePolicies.deleteConfirm': 'Delete Fee Policy?',
  'feePolicies.deleteWarning': 'This action cannot be undone. This will permanently delete the fee policy.',
  'feePolicies.modal.create': 'Create Fee Policy',
  'feePolicies.modal.edit': 'Edit Fee Policy',
  'feePolicies.modal.view': 'View Fee Policy',

  // Settings Errors
  'feePolicies.error.fetch': 'Failed to fetch fee policies',
  'feePolicies.error.delete': 'Failed to delete fee policy',
  'feePolicies.error.save': 'Failed to save fee policy',
  'locations.error.fetch': 'Failed to fetch locations',
  'locations.error.delete': 'Failed to delete location',
  'locations.error.save': 'Failed to save location',
  'libraries.error.fetch': 'Failed to fetch libraries',
  'libraries.error.delete': 'Failed to delete library',
  'libraries.error.save': 'Failed to save library',
  'loanPolicies.error.fetch': 'Failed to fetch loan policies',
  'loanPolicies.error.delete': 'Failed to delete loan policy',
  'loanPolicies.error.save': 'Failed to save loan policy',

  // Common Errors
  'common.error.processRequest': 'Failed to process request',
  'common.error.connectionFailed': 'Failed to establish real-time connection',
  'camera.error.accessFailed': 'Failed to access camera',
}
...
const arTranslations: Translations = {
  ...
  'nav.patronGroups': 'مجموعات المستفيدين',
  'nav.circulation': 'الإعارة',
  'nav.acquisitions': 'المشتريات',
  'nav.courses': 'الدورات',
  'nav.fees': 'الرسوم والغرامات',
  ...
  // User Errors
  'users.error.fetch': 'فشل في تحميل المستخدمين',
  'users.error.fetchUser': 'فشل في تحميل المستخدم',
  'users.error.create': 'فشل في إنشاء المستخدم',
  'users.error.update': 'فشل في تحديث المستخدم',
  'users.error.delete': 'فشل في حذف المستخدم',
  'users.error.fetchPatronGroups': 'فشل في تحميل مجموعات المستفيدين',
  'users.error.fetchDepartments': 'فشل في تحميل الأقسام',
  ...
  'roles.error.fetch': 'فشل في تحميل الأدوار',
  'roles.error.fetchRole': 'فشل في تحميل الدور',
  'roles.error.fetchPermissions': 'فشل في تحميل الصلاحيات',
  ...
  'items.error.fetch': 'فشل في تحميل العناصر',
  'items.error.save': 'فشل في حفظ العنصر',
  ...
  'holdings.error.fetch': 'فشل في جلب المقتنيات',
  'holdings.error.save': 'فشل في حفظ المقتنى',

  // Instances Errors
  'instances.error.fetch': 'فشل في جلب السجلات',
  'instances.error.create': 'فشل في إنشاء السجل',
  'instances.error.update': 'فشل في تحديث السجل',
  'instances.error.delete': 'فشل في حذف السجل',
  ...
  // Circulation - Recent Transactions
  'circulation.recentTransactions': 'العمليات الأخيرة',
  'circulation.noTransactions': 'لا توجد عمليات حديثة',
  'circulation.clear': 'مسح',
  'circulation.checkedOut': 'تم الإعارة',
  'circulation.checkedIn': 'تم الإرجاع',
  'circulation.renewed': 'تم التجديد',
  'circulation.unknownItem': 'عنصر غير معروف',
  'circulation.item': 'العنصر',
  'circulation.user': 'المستخدم',
  'circulation.due': 'الاستحقاق',
  'circulation.overdueFine': 'غرامة التأخير',
  ...
  'loans.renewSuccess': 'تم تجديد العنصر بنجاح!',
  'loans.error.renewFailed': 'فشل في تجديد العنصر',

  // Circulation Errors
  'circulation.error.checkout': 'فشل في إعارة العنصر',
  'circulation.error.checkin': 'فشل في إرجاع العنصر',
  'circulation.error.renew': 'فشل في تجديد الإعارة',
  'circulation.error.fetchLoans': 'فشل في تحميل الإعارات',
  'circulation.error.fetchRequests': 'فشل في تحميل الطلبات',
  'circulation.error.createRequest': 'فشل في إنشاء الطلب',
  'circulation.error.cancelRequest': 'فشل في إلغاء الطلب',

  // Requests (Arabic)
  'requests.cancelConfirm': 'هل أنت متأكد من إلغاء هذا الطلب؟',
  'circulation.requests.title': 'الطلبات (الحجوزات)',
  'circulation.requests.subtitle': 'إدارة طلبات الحجز والاستدعاء وطلبات الصفحة',
  'circulation.requests.createRequest': 'إنشاء طلب',
  'circulation.requests.noRequests': 'لا توجد طلبات',
  'circulation.requests.noRequests.desc': 'أنشئ طلبك الأول للبدء',
  'circulation.requests.position': 'الموضع',
  'circulation.requests.item': 'العنصر',
  'circulation.requests.user': 'المستخدم',
  'circulation.requests.type': 'النوع',
  'circulation.requests.requestDate': 'تاريخ الطلب',
  'circulation.requests.expirationDate': 'تاريخ انتهاء الصلاحية',
  'circulation.requests.status': 'الحالة',
  'circulation.requests.status.open': 'مفتوح',
  'circulation.requests.status.closed': 'مغلق',
  'circulation.requests.status.cancelled': 'ملغى',
  'circulation.requests.type.hold': 'حجز',
  'circulation.requests.type.recall': 'استدعاء',
  'circulation.requests.type.page': 'صفحة',
  'circulation.requests.filters.status': 'تصفية حسب الحالة',
  'circulation.requests.filters.type': 'تصفية حسب النوع',
  'circulation.requests.form.userBarcode': 'باركود المستخدم',
  'circulation.requests.form.userBarcodePlaceholder': 'امسح أو أدخل باركود المستخدم',
  'circulation.requests.form.itemBarcode': 'باركود العنصر',
  'circulation.requests.form.itemBarcodePlaceholder': 'امسح أو أدخل باركود العنصر',
  'circulation.requests.form.requestType': 'نوع الطلب',
  'circulation.requests.form.expirationDate': 'تاريخ انتهاء الصلاحية (اختياري)',
  'circulation.requests.form.optional': 'حقل اختياري',
  'circulation.requests.button.create': 'إنشاء طلب',
  'circulation.requests.button.cancelRequest': 'إلغاء الطلب',
  'circulation.requests.cancel.confirm': 'إلغاء الطلب؟',
  'circulation.requests.cancel.message': 'هل أنت متأكد من إلغاء الطلب لـ "{itemTitle}"؟',
  'circulation.requests.cancel.warning': 'لا يمكن التراجع عن هذا الإجراء.',
  'circulation.requests.cancelSuccess': 'تم إلغاء الطلب بنجاح',
  'circulation.requests.cancelError': 'فشل في إلغاء الطلب',
  'circulation.requests.createSuccess': 'تم إنشاء الطلب بنجاح',
  'circulation.requests.createError': 'فشل في إنشاء الطلب',
  ...
  'reports.form.exportFormat': 'صيغة التصدير',
  'reports.form.startDate': 'تاريخ البدء',
  'reports.form.endDate': 'تاريخ الانتهاء',
  'reports.form.includeFines': 'تضمين الغرامات',
  'reports.form.includeStats': 'تضمين الإحصائيات',
  'reports.form.minDaysOverdue': 'الحد الأدنى من أيام التأخير',
  'reports.types.circulation': 'الإعارة',
  'reports.types.collection': 'المجموعة',
  'reports.types.financial': 'المالي',
  'reports.types.overdue': 'المتأخرات',
  'reports.titles.circulation': 'تقرير الإعارة',
  'reports.titles.collection': 'تقرير المجموعة',
  'reports.titles.financial': 'التقرير المالي',
  'reports.titles.overdue': 'تقرير المتأخرات',
  'reports.formats.json': 'JSON',
  'reports.formats.csv': 'CSV',
  'reports.formats.excel': 'Excel',
  'reports.formats.pdf': 'PDF',
  'reports.stats.totalCheckouts': 'إجمالي الإعارات',
  'reports.stats.totalItems': 'إجمالي العناصر',
  'reports.stats.totalUsers': 'إجمالي المستخدمين',
  'reports.stats.allocatedFunds': 'الأموال المخصصة',
  'reports.stats.expended': 'المصروف',
  'reports.stats.available': 'الأموال المتاحة',
  'reports.display.generated': 'تم الإنشاء',
  'reports.display.totalRecords': 'إجمالي السجلات',
  'reports.display.summary': 'الملخص',
  'reports.display.showing100': 'عرض أول 100 من {{total}} سجل',
  'reports.display.noData': 'لا توجد بيانات متاحة',
  ...
  'audit.actions.read': 'قراءة',

  // Audit Logs - Resources (Arabic)
  'audit.resources.users': 'المستخدمون',
  'audit.resources.instances': 'السجلات',
  'audit.resources.items': 'العناصر',
  'audit.resources.loans': 'الإعارات',
  'audit.resources.holdings': 'النسخ',
  'audit.resources.orders': 'الطلبات',
  'audit.resources.invoices': 'الفواتير',
  ...
  // Additional Vendor translations
  'acquisitions.vendors.subtitle': 'إدارة علاقات الموردين وشروط الدفع',
  'acquisitions.vendors.modal.create': 'إنشاء مورد',
  'acquisitions.vendors.modal.edit': 'تعديل المورد',
  'acquisitions.vendors.modal.createDesc': 'إضافة مورد جديد إلى نظام المشتريات',
  'acquisitions.vendors.modal.editDesc': 'تحديث معلومات وإعدادات المورد',
  'acquisitions.vendors.paymentMethodPlaceholder': 'أدخل طريقة الدفع',
  'acquisitions.vendors.deleteTitle': 'حذف المورد',
  ...
  // Additional Invoice translations
  'acquisitions.invoices.subtitle': 'إدارة ومعالجة فواتير الموردين',
  ...
  'acquisitions.invoices.modal.view': 'عرض الفاتورة',
  'acquisitions.invoices.modal.createDesc': 'إنشاء فاتورة جديدة لدفع المورد',
  'acquisitions.invoices.modal.editDesc': 'تحديث تفاصيل الفاتورة ومعلومات الدفع',
  'acquisitions.invoices.modal.viewDesc': 'عرض تفاصيل الفاتورة',
  'acquisitions.invoices.table.invoiceNumber': 'رقم الفاتورة',
  'acquisitions.invoices.table.vendor': 'المورد',
  'acquisitions.invoices.table.date': 'تاريخ الفاتورة',
  'acquisitions.invoices.table.status': 'الحالة',
  'acquisitions.invoices.table.total': 'المبلغ الإجمالي',
  'acquisitions.invoices.table.actions': 'الإجراءات',
  'acquisitions.invoices.form.invoiceNumber': 'رقم الفاتورة',
  'acquisitions.invoices.form.invoiceNumberPlaceholder': 'أدخل رقم الفاتورة',
  ...
  'acquisitions.invoices.form.descriptionPlaceholder': 'أدخل وصف الفاتورة',
  'acquisitions.invoices.deleteTitle': 'حذف الفاتورة',
  ...
  'fees.error.fetch': 'فشل في تحميل الرسوم',
  'fees.error.fetchPayments': 'فشل في تحميل المدفوعات',
  ...
  'courses.deleteConfirm': 'هل أنت متأكد من حذف هذه الدورة؟ سيؤدي ذلك إلى حذف جميع المحتويات المرتبطة.',
  ...
  // Courses - Errors
  'courses.error.fetch': 'فشل في تحميل الدورات',
  'courses.error.fetchCourse': 'فشل في تحميل الدورة',
  'courses.error.create': 'فشل في إنشاء الدورة',
  'courses.error.update': 'فشل في تحديث الدورة',
  'courses.error.delete': 'فشل في حذف الدورة',
  'reserves.error.fetch': 'فشل في تحميل المحتويات',
  'reserves.error.create': 'فشل في إنشاء محتوى',
  'reserves.error.delete': 'فشل في حذف محتوى',
  ...
  'acquisitions.funds.modal.createDesc': 'إضافة صندوق جديد إلى نظام المشتريات',
  'acquisitions.funds.modal.editDesc': 'تحديث معلومات الصندوق وتفاصيل الميزانية',
  'acquisitions.funds.modal.viewDesc': 'عرض تفاصيل الصندوق ومعلومات التخصيص',
  'acquisitions.funds.noFunds': 'لم يتم العثور على صناديق',
  'acquisitions.funds.subtitle': 'إدارة ميزانيات المكتبة وتخصيصات الصناديق',
  'acquisitions.funds.codePlaceholder': 'أدخل رمز الصندوق',
  'acquisitions.funds.namePlaceholder': 'أدخل اسم الصندوق',
  'acquisitions.funds.descriptionPlaceholder': 'أدخل وصف الصندوق',
  'acquisitions.funds.deleteTitle': 'حذف الصندوق',
  ...
  // Acquisitions Errors
  'vendors.error.fetch': 'فشل في تحميل الموردين',
  'vendors.error.fetchVendor': 'فشل في تحميل المورد',
  'vendors.error.create': 'فشل في إنشاء المورد',
  'vendors.error.update': 'فشل في تحديث المورد',
  'vendors.error.delete': 'فشل في حذف المورد',
  'funds.error.fetch': 'فشل في تحميل الصناديق',
  'funds.error.create': 'فشل في إنشاء الصندوق',
  'funds.error.update': 'فشل في تحديث الصندوق',
  'funds.error.delete': 'فشل في حذف الصندوق',
  'purchaseOrders.error.fetch': 'فشل في تحميل أوامر الشراء',
  'purchaseOrders.error.fetchOrder': 'فشل في تحميل أمر الشراء',
  'purchaseOrders.error.create': 'فشل في إنشاء أمر الشراء',
  'purchaseOrders.error.update': 'فشل في تحديث أمر الشراء',
  'purchaseOrders.error.delete': 'فشل في حذف أمر الشراء',
  'invoices.error.fetch': 'فشل في تحميل الفواتير',
  'invoices.error.fetchInvoice': 'فشل في تحميل الفاتورة',
  ...
  // Notifications Errors
  'notifications.error.fetch': 'فشل في تحميل الإشعارات',
  'notifications.error.fetchUnread': 'فشل في تحميل عدد الإشعارات غير المقروءة',
  'notifications.error.markRead': 'فشل في وضع علامة مقروء على الإشعار',
  'notifications.error.markAllRead': 'فشل في وضع علامة مقروء على جميع الإشعارات',
  'notifications.error.delete': 'فشل في حذف الإشعار',
  'notifications.error.deleteAll': 'فشل في حذف الإشعارات',

  // Dashboard Errors
  'dashboard.error.fetchStats': 'فشل في تحميل إحصائيات لوحة التحكم',
  'dashboard.error.fetchLoans': 'فشل في تحميل الإعارات الأخيرة',

  // Auth Errors
  'auth.error.fetchProfile': 'فشل في تحميل ملف المستخدم',

  // Settings - Locations (Arabic)
  'locations.title': 'المواقع',
  'locations.subtitle': 'إدارة المواقع الفعلية للعناصر',
  'locations.new': 'موقع جديد',
  'locations.filterByLibrary': 'تصفية حسب المكتبة',
  'locations.allLibraries': 'جميع المكتبات',
  'locations.filterByStatus': 'تصفية حسب الحالة',
  'locations.allStatuses': 'جميع الحالات',
  'locations.noLocations': 'لم يتم العثور على مواقع',
  'locations.noLocations.desc': 'أنشئ أول موقع للبدء',
  'locations.code': 'الرمز',
  'locations.name': 'الاسم',
  'locations.library': 'المكتبة',
  'locations.modal.create': 'إنشاء موقع',
  'locations.modal.edit': 'تعديل الموقع',
  'locations.modal.view': 'عرض الموقع',
  'locations.modal.createDesc': 'إضافة موقع جديد إلى النظام',
  'locations.modal.editDesc': 'تحديث معلومات الموقع',
  'locations.modal.viewDesc': 'عرض تفاصيل الموقع',
  'locations.codeImmutable': 'لا يمكن تغيير الرمز بعد الإنشاء',
  'locations.description': 'الوصف',
  'locations.descriptionPlaceholder': 'أدخل وصف الموقع...',
  'locations.discoveryDisplayName': 'اسم العرض في الكتالوج',
  'locations.discoveryPlaceholder': 'الاسم المعروض في الكتالوج العام',
  'locations.discoveryHelp': 'الاسم الذي يظهر للمستفيدين في الكتالوج العام',
  'locations.noLibrary': 'بدون مكتبة',
  'locations.activeLocation': 'موقع نشط',
  'locations.deleteTitle': 'حذف الموقع',
  'locations.deleteConfirm': 'هل أنت متأكد من حذف هذا الموقع؟ قد يؤثر ذلك على العناصر المرتبطة به.',
  'locations.namePlaceholder': 'الرفوف الرئيسية',

  // Settings - Libraries (Arabic)
  'libraries.title': 'المكتبات',
  'libraries.subtitle': 'إدارة فروع المكتبة والوحدات التنظيمية',
  'libraries.new': 'مكتبة جديدة',
  'libraries.searchPlaceholder': 'ابحث عن المكتبات...',
  'libraries.noLibraries': 'لم يتم العثور على مكتبات',
  'libraries.noLibraries.desc': 'أنشئ أول مكتبة للبدء',
  'libraries.table.code': 'الرمز',
  'libraries.table.name': 'الاسم',
  'libraries.table.created': 'تاريخ الإنشاء',
  'libraries.table.actions': 'الإجراءات',
  'libraries.modal.create': 'إنشاء مكتبة',
  'libraries.modal.edit': 'تعديل المكتبة',
  'libraries.modal.view': 'عرض المكتبة',
  'libraries.modal.createDesc': 'إضافة فرع مكتبة جديد إلى النظام',
  'libraries.modal.editDesc': 'تحديث معلومات المكتبة',
  'libraries.modal.viewDesc': 'عرض تفاصيل المكتبة',
  'libraries.form.code': 'رمز المكتبة',
  'libraries.form.name': 'اسم المكتبة',
  'libraries.codeImmutable': 'لا يمكن تغيير الرمز بعد الإنشاء',
  'libraries.codeHelp': 'رمز فريد لتحديد هذه المكتبة (مثل: MAIN، BRANCH1)',
  'libraries.namePlaceholder': 'المكتبة الرئيسية',
  'libraries.nameHelp': 'الاسم الكامل للمكتبة',
  'libraries.created': 'تاريخ الإنشاء',
  'libraries.updated': 'تاريخ التحديث',
  'libraries.deleteTitle': 'حذف المكتبة',
  'libraries.deleteConfirm': 'هل أنت متأكد من حذف هذه المكتبة؟ قد يؤثر ذلك على المواقع المرتبطة.',

  // Settings - Loan Policies (Arabic)
  'loanPolicies.title': 'سياسات الإعارة',
  'loanPolicies.subtitle': 'تكوين قواعد الإعارة وفترات الاستعارة',
  'loanPolicies.new': 'سياسة إعارة جديدة',
  'loanPolicies.filterByStatus': 'تصفية حسب الحالة',
  'loanPolicies.allStatuses': 'جميع الحالات',
  'loanPolicies.activeOnly': 'نشط فقط',
  'loanPolicies.inactiveOnly': 'غير نشط فقط',
  'loanPolicies.noPolicies': 'لم يتم العثور على سياسات إعارة',
  'loanPolicies.noPolicies.desc': 'أنشئ أول سياسة للبدء',
  'loanPolicies.code': 'الرمز',
  'loanPolicies.name': 'الاسم',
  'loanPolicies.loanPeriod': 'فترة الإعارة',
  'loanPolicies.renewability': 'قابلية التجديد',
  'loanPolicies.grace': 'السماح',
  'loanPolicies.yes': 'نعم',
  'loanPolicies.no': 'لا',
  'loanPolicies.renewals': 'تجديدات',
  'loanPolicies.modal.create': 'إنشاء سياسة إعارة',
  'loanPolicies.modal.edit': 'تعديل سياسة الإعارة',
  'loanPolicies.modal.view': 'عرض سياسة الإعارة',
  'loanPolicies.modal.createDesc': 'إضافة سياسة إعارة جديدة لتكوين قواعد الإعارة',
  'loanPolicies.modal.editDesc': 'تحديث إعدادات وفترات سياسة الإعارة',
  'loanPolicies.modal.viewDesc': 'عرض تفاصيل وإعدادات سياسة الإعارة',
  'loanPolicies.codeHelp': 'رمز فريد (مثل: STANDARD_LOAN، SHORT_TERM)',
  'loanPolicies.namePlaceholder': 'سياسة الإعارة القياسية',
  'loanPolicies.descriptionPlaceholder': 'وصف لسياسة الإعارة هذه',
  'loanPolicies.description': 'الوصف',
  'loanPolicies.duration': 'المدة',
  'loanPolicies.interval': 'الفترة',
  'loanPolicies.renewable': 'قابل للتجديد',
  'loanPolicies.numberOfRenewals': 'عدد التجديدات',
  'loanPolicies.renewalDuration': 'مدة التجديد',
  'loanPolicies.renewalInterval': 'فترة التجديد',
  'loanPolicies.gracePeriod': 'فترة السماح',
  'loanPolicies.graceHelp': 'الفترة بعد تاريخ الاستحقاق قبل تطبيق رسوم التأخير',
  'loanPolicies.recallConfig': 'إعدادات الاستدعاء (اختياري)',
  'loanPolicies.returnIntervalDuration': 'مدة فترة الإرجاع',
  'loanPolicies.returnInterval': 'فترة الإرجاع',
  'loanPolicies.recallPlaceholder': 'اتركه فارغاً إذا لم ينطبق',
  'loanPolicies.deleteTitle': 'حذف سياسة الإعارة',
  'loanPolicies.deleteConfirm': 'هل أنت متأكد من حذف سياسة الإعارة هذه؟',

  // Settings - Fee Policies (Arabic)
  ...
  'feePolicies.filterByType': 'تصفية حسب النوع',
  'feePolicies.filterByStatus': 'تصفية حسب الحالة',
  'feePolicies.allTypes': 'جميع أنواع الرسوم',
  'feePolicies.allStatuses': 'جميع الحالات',
  'feePolicies.activeOnly': 'نشط فقط',
  'feePolicies.inactiveOnly': 'غير نشط فقط',
  'feePolicies.noPolicies': 'لم يتم العثور على سياسات رسوم',
  'feePolicies.noPolicies.desc': 'أنشئ أول سياسة للبدء',
  'feePolicies.table.code': 'الرمز',
  'feePolicies.table.name': 'الاسم',
  'feePolicies.table.type': 'نوع الرسوم',
  'feePolicies.table.amounts': 'المبالغ',
  'feePolicies.table.status': 'الحالة',
  'feePolicies.code': 'الرمز',
  'feePolicies.codeHint': 'رمز فريد (مثل: OVERDUE_STD، LOST_ITEM)',
  'feePolicies.feeType': 'نوع الرسوم',
  'feePolicies.name': 'الاسم',
  'feePolicies.namePlaceholder': 'سياسة التأخير القياسية',
  'feePolicies.description': 'الوصف',
  'feePolicies.descriptionPlaceholder': 'وصف سياسة الرسوم هذه',
  'feePolicies.feeAmounts': 'مبالغ الرسوم',
  'feePolicies.initialAmount': 'ابتدائي',
  'feePolicies.initialAmountHint': 'الرسوم الأولية عند إنشاء الرسم',
  'feePolicies.perDay': 'يومي',
  'feePolicies.perDayAmount': 'المبلغ اليومي',
  'feePolicies.perDayAmountHint': 'المعدل اليومي (لرسوم التأخير)',
  'feePolicies.max': 'الحد الأقصى',
  'feePolicies.maxAmount': 'المبلغ الأقصى',
  'feePolicies.maxAmountHint': 'الحد الأقصى للرسوم',
  'feePolicies.grace': 'سماح',
  'feePolicies.gracePeriod': 'فترة السماح (أيام)',
  'feePolicies.gracePeriodHint': 'الأيام قبل بدء احتساب الرسوم',
  'feePolicies.days': 'أيام',
  'feePolicies.created': 'تاريخ الإنشاء',
  'feePolicies.updated': 'تاريخ التحديث',
  'feePolicies.id': 'المعرف',
  'feePolicies.deleteConfirm': 'حذف سياسة الرسوم؟',
  'feePolicies.deleteWarning': 'لا يمكن التراجع عن هذا الإجراء. سيؤدي هذا إلى حذف سياسة الرسوم نهائياً.',
  'feePolicies.modal.create': 'إنشاء سياسة رسوم',
  'feePolicies.modal.edit': 'تعديل سياسة الرسوم',
  'feePolicies.modal.view': 'عرض سياسة الرسوم',

  // Settings Errors
  'feePolicies.error.fetch': 'فشل في تحميل سياسات الرسوم',
  'feePolicies.error.delete': 'فشل في حذف سياسة الرسوم',
  'feePolicies.error.save': 'فشل في حفظ سياسة الرسوم',
  'locations.error.fetch': 'فشل في تحميل المواقع',
  'locations.error.delete': 'فشل في حذف الموقع',
  'locations.error.save': 'فشل في حفظ الموقع',
  'libraries.error.fetch': 'فشل في تحميل المكتبات',
  'libraries.error.delete': 'فشل في حذف المكتبة',
  'libraries.error.save': 'فشل في حفظ المكتبة',
  'loanPolicies.error.fetch': 'فشل في تحميل سياسات الإعارة',
  'loanPolicies.error.delete': 'فشل في حذف سياسة الإعارة',
  'loanPolicies.error.save': 'فشل في حفظ سياسة الإعارة',

  // Common Errors
  'common.error.processRequest': 'فشل في معالجة الطلب',
  'common.error.connectionFailed': 'فشل في إنشاء اتصال في الوقت الفعلي',
  'camera.error.accessFailed': 'فشل في الوصول إلى الكاميرا',
}

...
const enTranslations: Translations = {
  ...
  'acquisitions.invoices.searchPlaceholder': 'Search invoices...',
  'acquisitions.invoices.deleteConfirm': 'Are you sure you want to delete this invoice?',
  'acquisitions.invoices.table.invoiceNumber': 'Invoice Number',
  ...
  'acquisitions.invoices.form.invoiceNumber': 'Invoice Number',
  'acquisitions.invoices.form.number': 'Invoice Number',
  'acquisitions.invoices.form.vendor': 'Vendor',
  'acquisitions.invoices.form.selectVendor': 'Select vendor...',
  'acquisitions.invoices.form.invoiceDate': 'Invoice Date',
  'acquisitions.invoices.form.paymentDueDate': 'Payment Due Date',
  'acquisitions.invoices.form.status': 'Status',
  'acquisitions.invoices.form.totalAmount': 'Total Amount',
  'acquisitions.invoices.form.amount': 'Amount',
  'acquisitions.invoices.form.description': 'Description',
  'acquisitions.invoices.status.open': 'Open',
  'acquisitions.invoices.status.approved': 'Approved',
  'acquisitions.invoices.status.paid': 'Paid',
  'acquisitions.invoices.status.cancelled': 'Cancelled',
  'acquisitions.invoices.modal.create': 'Create Invoice',
  'acquisitions.invoices.modal.edit': 'Edit Invoice',
  'acquisitions.invoices.modal.view': 'Invoice Details',
  'acquisitions.invoices.noInvoices': 'No invoices found',
...
const arTranslations: Translations = {
  ...
  'acquisitions.invoices.deleteConfirm': 'هل أنت متأكد من حذف هذه الفاتورة؟',
  'acquisitions.invoices.table.invoiceNumber': 'رقم الفاتورة',
  ...
  'acquisitions.invoices.form.invoiceNumber': 'رقم الفاتورة',
  'acquisitions.invoices.form.number': 'رقم الفاتورة',
  'acquisitions.invoices.form.vendor': 'المورد',
  'acquisitions.invoices.form.selectVendor': 'اختر المورد...',
  'acquisitions.invoices.form.invoiceDate': 'تاريخ الفاتورة',
  'acquisitions.invoices.form.paymentDueDate': 'تاريخ استحقاق الدفع',
  'acquisitions.invoices.form.status': 'الحالة',
  'acquisitions.invoices.form.totalAmount': 'المبلغ الإجمالي',
  'acquisitions.invoices.form.amount': 'المبلغ',
  'acquisitions.invoices.form.description': 'الوصف',
  'acquisitions.invoices.status.open': 'مفتوحة',
  'acquisitions.invoices.status.approved': 'موافق عليها',
  'acquisitions.invoices.status.paid': 'مدفوعة',
  'acquisitions.invoices.status.cancelled': 'ملغاة',
  'acquisitions.invoices.modal.create': 'إنشاء فاتورة',
  'acquisitions.invoices.modal.edit': 'تعديل الفاتورة',
  'acquisitions.invoices.modal.view': 'تفاصيل الفاتورة',
  'acquisitions.invoices.noInvoices': 'لم يتم العثور على فواتير',
